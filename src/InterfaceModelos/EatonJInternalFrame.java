 ...
 * @author Miguel
 */
public class EatonJInternalFrame extends javax.swing.JInternalFrame {

    /**
     * Creates new form EatonJInternalFrame
     */
    ArrayList<Double> a = new ArrayList();
    ArrayList<Double> b = new ArrayList();
    private Object[] objetoEaton;
    private Eaton eaton; 
    ...
    public void crearVectores() {
        objetoEaton = new Object[3];
        double Longitud = L;
        for (int i = 0; i < 3; i++) {
            //eaton = new Eaton(P1, P1, Tprom, Yg, Yw, qL, RGL, d)
            a.add(Longitud);
            //b.add(eaton.getDPTg());            
            objetoEaton[i] = (Object) eaton;
    ...
    private void initComponents() {
        ...
        jPanel10.setLayout(new java.awt.GridLayout(7, 1, 15, 15));
        ...
        jPanel11.setLayout(new java.awt.GridLayout(7, 1, 15, 15));
